<template>
    <div>
        <Modal v-model="isTemplate" scrollable  footer-hide closable :title="formItem.id?'编辑提货点':'添加提货点'"  :z-index="1" width="700" @on-cancel="cancel">
                ...
                <Card :bordered="false" dis-hover class="ivu-mt">
                    <Form ref="formItem" :model="formItem" :label-width="120" label-position="right" :rules="ruleValidate" @submit.native.prevent>
                        <Row type="flex" :gutter="24">
                            ...
                            <Col span="24">
                                <Col v-bind="grid">
                                    <FormItem label="提货点大图：" prop="image">
                                        <div class="picBox" @click="modalPicTap('单选','oblong')">
                                            <div class="pictrue" v-if="formItem.oblong_image"><img v-lazy="formItem.oblong_image"></div>
                                            <div class="upLoad acea-row row-center-wrapper"   v-else>
                                                <Icon type="ios-camera-outline" size="26"/>
                                            </div>
                                        </div>
