<template>
    <div class="Box">
        <Card>
            <div>生成的商品默认是没有上架的，请手动上架商品！<a href="https://www.kancloud.cn/crmeb/crmebpro/1837991" target="_blank">如何配置密钥</a></div>
        </Card>
        <Form class="formValidate mt20" ref="formValidate" :model="formValidate" :rules="ruleInline" :label-width="120" label-position="right" @submit.native.prevent>
