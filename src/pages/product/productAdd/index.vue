                  ...
                  <Col span="24">
                    ...
                    <Col span="24">
                        <FormItem label="运费模板：" prop="temp_id">
                            <div class="acea-row">
                                <Select v-model="formValidate.temp_id" clearable class="mr20 perW50">
                ...
                <Row type="flex" justify="space-between" v-show="currentTab === '3'">
                    ...
                    <Col span="24" v-if="formValidate.is_sub === 1">
                        ...
                        <FormItem label="批量设置：" v-if="formValidate.spec_type === 1">
                            <InputNumber placeholder="请输入一级返佣" :min="0" class="columnsBox perW20" v-model="manyBrokerage"></InputNumber>
                            <InputNumber placeholder="请输入二级返佣" :min="0" class="columnsBox perW20" v-model="manyBrokerageTwo"></InputNumber>
